<template>
    <div>
        <div class="flex space-x-4 p-5">
            ...
            <span v-if="$slots['filters']" class="select rounded-md border border-gray-300 cursor-pointer" @click="filtering = true" :class="{'bg-blue-100 border-2 border-blue-500': isFiltering, 'bg-white': !isFiltering}">
                Filters
            </span>
      </div>
                        ...
                        <div class="h-full flex flex-col py-6 bg-white shadow-xl overflow-y-scroll">
                            ...
                            <div class="mt-6 relative flex-1 px-4 sm:px-6">
                                <div class="absolute inset-0 px-4 sm:px-6">
                                    <div class="h-full flex justify-between flex-col" aria-hidden="true">
                                        ...
                                        <div class="flex space-x-4 pb-8 pt-4 border-t mt-4">
                                            ...
                                            <jet-secondary-button @click="clearFilters">Clear</jet-secondary-button>
                                        </div>
                                    </div>
                                </div>
                            </div>
